...
namespace GandomShopsMarket.Infrastructure.Repositories;
...
public class CommandGenericRepository<TEntity> where TEntity : class
{
    ...
    protected readonly GandomShopsMarketDbContext _context;

    public DbSet<TEntity> Entities { get; }

    public CommandGenericRepository(GandomShopsMarketDbContext context)
    {
        _context = context;
